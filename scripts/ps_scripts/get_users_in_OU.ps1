...
$scriptBlock = {
    ...
    $OU = "OU=Consultants_Users_Contacts,OU=Pierce,DC=corp,DC=pierce-ecom,DC=com"
...
$usersInfo | Export-Csv -Path "C:\Users\fredrik.andersson\ConsultantUsers.csv" -NoTypeInformation -Encoding UTF8
